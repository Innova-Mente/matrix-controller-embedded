# ESP-8266 setup for Microworlds integration
...
After flashing each embedded system, monitor the serial port to ensure that the embedded system is connected to the message broker. You can also verify the connection by checking the message broker's terminal output or visiting the overview website.
